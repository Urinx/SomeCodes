...
8|a[2]:0}function sa(a,b,c){var d;d=a?a+"FontStyle":"fontStyle";var e=a?a+"FontWeight":"fontWeight",f=a?a+"FontSize":"fontSize";a=a?a+"FontFamily":"fontFamily";d=""+(b[d]?b[d]+" ":c&&c[d]?c[d]+" ":"");d+=b[e]?b[e]+" ":c&&c[e]?c[e]+" ":"";d+=b[f]?b[f]+"px ":c&&c[f]?c[f]+"px ":"";b=b[a]?b[a]+"":c&&c[a]?c[a]+"":"";!u&&b&&(b=b.split(",")[0],"'"!==b[0]&&'"'!==b[0]&&(b="'"+b+"'"));return d+=b}function R(a,b,c){return a in b?b[a]:c[a]}function ca(a,b,c){if(u&&ta){var d=a.getContext("2d");da=d.webkitBackingStorePixelRatio||
...
!1),va(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))):this.panEnabled=this.zoomEnabled=!1;this.exportEnabled&&(u&&!this._menuButton)&&(this._menuButton=document.createElement("button"),L(this,this._menuButton,"menu"),this._toolBar.appendChild(this._menuButton),F(this._menuButton,"click",function(){"none"!==a._dropdownMenu.style.display||a._dropDownCloseTime&&500>=(new Date).getTime()-a._dropDownCloseTime.getTime()||(a._dropdownMenu.style.display="block",a._menuButton.blur(),
...
"line"!==d[c].dataSeries.type&&"stepLine"!==d[c].dataSeries.type&&"area"!==d[c].dataSeries.type&&"stepArea"!==d[c].dataSeries.type||(a?d[c].distance<=a.distance&&(a=d[c]):a=d[c]);return a};w.prototype.getObjectAtXY=function(a,b,c){var d=null;if(c=this.getDataPointAtXY(a,b,c||!1))d=c.dataSeries.dataPointIds[c.dataPointIndex];else if(u)d=ra(a,b,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&b>=e.y1&&b<=e.y2)&&(d=e.id)}return d};
...
this.axisY2;!u&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);this.axisX&&b?(a.x1=this.axisX.lineCoordinates.x1<this.axisX.lineCoordinates.x2?this.axisX.lineCoordinates.x1:b.lineCoordinates.x1,a.y1=this.axisX.lineCoordinates.y1<b.lineCoordinates.y1?this.axisX.lineCoordinates.y1:b.lineCoordinates.y1,a.x2=this.axisX.lineCoordinates.x2>b.lineCoordinates.x2?this.axisX.lineCoordinates.x2:b.lineCoordinates.x2,a.y2=this.axisX.lineCoordinates.y2>this.axisX.lineCoordinates.y1?this.axisX.lineCoordinates.y2:
b.lineCoordinates.y2,a.width=a.x2-a.x1,a.height=a.y2-a.y1):(b=this.layoutManager.getFreeSpace(),a.x1=b.x1,a.x2=b.x2,a.y1=b.y1,a.y2=b.y2,a.width=b.width,a.height=b.height);u||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1))};w.prototype.getPixelCoordinatesOnPlotArea=function(a,b){return{x:this.axisX.getPixelCoordinatesOnAxis(a).x,y:this.axisY.getPixelCoordinatesOnAxis(b).y}};w.prototype.renderIndexLabels=
function(){var a=this.plotArea.ctx;a.textBaseline="middle";for(var b=this.plotArea,c=0;c<this._indexLabels.length;c++){var d=this._indexLabels[c],e,f,g;a.fillStyle=R("indexLabelFontColor",d.dataPoint,d.dataSeries);a.font=sa("indexLabel",d.dataPoint,d.dataSeries);var l=this.replaceKeywordsWithValue(R("indexLabel",d.dataPoint,d.dataSeries),d.dataPoint,d.dataSeries,null,d.indexKeyword),q=a.measureText(l).width,h=R("indexLabelFontSize",d.dataPoint,d.dataSeries),k=R("indexLabelPlacement",d.dataPoint,d.dataSeries),
n=R("indexLabelOrientation",d.dataPoint,d.dataSeries),m=g=0,r=0,p=0,p=m=r=0,s=d.direction;d.point.x<b.x1||(d.point.x>b.x2||d.point.y<b.y1||d.point.y>b.y2)||("column"===d.chartType||"stackedColumn"===d.chartType||"stackedColumn100"===d.chartType||"bar"===d.chartType||"stackedBar"===d.chartType||"stackedBar100"===d.chartType||"candlestick"===d.chartType||"ohlc"===d.chartType||"rangeColumn"===d.chartType||"rangeBar"===d.chartType?(m=p=5,Math.abs(d.bounds.x1,d.bounds.x2),Math.abs(d.bounds.y1,d.bounds.y2),
...
g=-90)),a.save(),a.translate(e,f),a.rotate(Math.PI/180*g),a.fillText(l,0,0),a.restore())}};w.prototype.renderLine=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx;b.save();var d=this.plotArea;b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();for(var d=[],e=0;e<a.dataSeriesIndexes.length;e++){var f=a.dataSeriesIndexes[e],g=this.data[f];b.lineWidth=g.lineThickness;var l=g.dataPoints,q=g.id;this._eventManager.objectMap[q]={objectType:"dataSeries",
dataSeriesIndex:f};q=A(q);c.strokeStyle=q;c.lineWidth=0<g.lineThickness?Math.max(g.lineThickness,4):0;q=g._colorSet[0];b.strokeStyle=q;var h=!0,k=0,n,m;b.beginPath();if(0<l.length){for(var r=!1,k=0;k<l.length;k++)if(n=l[k].x.getTime?l[k].x.getTime():l[k].x,!(n<a.axisX.dataInfo.viewPortMin||n>a.axisX.dataInfo.viewPortMax))if("number"!==typeof l[k].y)0<k&&(b.stroke(),u&&c.stroke()),r=!0;else{n=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(n-a.axisX.conversionParameters.minimum)+
0.5<<0;m=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(l[k].y-a.axisY.conversionParameters.minimum)+0.5<<0;var p=g.dataPointIds[k];this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:f,dataPointIndex:k,x1:n,y1:m};h||r?(b.beginPath(),b.moveTo(n,m),u&&(c.beginPath(),c.moveTo(n,m)),r=h=!1):(b.lineTo(n,m),u&&c.lineTo(n,m),0==k%500&&(b.stroke(),b.beginPath(),b.moveTo(n,m),u&&(c.stroke(),c.beginPath(),c.moveTo(n,m))));if(0<l[k].markerSize||0<
g.markerSize){var s=g.getMarkerProperties(k,n,m,b);d.push(s);p=A(p);u&&d.push({x:n,y:m,ctx:c,type:s.type,size:s.size,color:p,borderColor:p,borderThickness:s.borderThickness})}(l[k].indexLabel||g.indexLabel)&&this._indexLabels.push({chartType:"line",dataPoint:l[k],dataSeries:g,point:{x:n,y:m},color:q})}b.stroke();u&&c.stroke()}}I.drawMarkers(d);b.restore();b.beginPath();u&&c.beginPath()}};w.prototype.renderStepLine=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx;
b.save();var d=this.plotArea;b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();for(var d=[],e=0;e<a.dataSeriesIndexes.length;e++){var f=a.dataSeriesIndexes[e],g=this.data[f];b.lineWidth=g.lineThickness;var l=g.dataPoints,q=g.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:f};q=A(q);c.strokeStyle=q;c.lineWidth=0<g.lineThickness?Math.max(g.lineThickness,4):0;q=g._colorSet[0];b.strokeStyle=q;var h=!0,k=0,n,m;b.beginPath();if(0<l.length){for(var r=!1,k=0;k<l.length;k++)if(n=
l[k].getTime?l[k].x.getTime():l[k].x,!(n<a.axisX.dataInfo.viewPortMin||n>a.axisX.dataInfo.viewPortMax))if("number"!==typeof l[k].y)0<k&&(b.stroke(),u&&c.stroke()),r=!0;else{var p=m;n=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(n-a.axisX.conversionParameters.minimum)+0.5<<0;m=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(l[k].y-a.axisY.conversionParameters.minimum)+0.5<<0;var s=g.dataPointIds[k];this._eventManager.objectMap[s]=
{id:s,objectType:"dataPoint",dataSeriesIndex:f,dataPointIndex:k,x1:n,y1:m};h||r?(b.beginPath(),b.moveTo(n,m),u&&(c.beginPath(),c.moveTo(n,m)),r=h=!1):(b.lineTo(n,p),u&&c.lineTo(n,p),b.lineTo(n,m),u&&c.lineTo(n,m),0==k%500&&(b.stroke(),b.beginPath(),b.moveTo(n,m),u&&(c.stroke(),c.beginPath(),c.moveTo(n,m))));if(0<l[k].markerSize||0<g.markerSize)p=g.getMarkerProperties(k,n,m,b),d.push(p),s=A(s),u&&d.push({x:n,y:m,ctx:c,type:p.type,size:p.size,color:s,borderColor:s,borderThickness:p.borderThickness});
(l[k].indexLabel||g.indexLabel)&&this._indexLabels.push({chartType:"stepLine",dataPoint:l[k],dataSeries:g,point:{x:n,y:m},color:q})}b.stroke();u&&c.stroke()}}I.drawMarkers(d);b.restore();b.beginPath();u&&c.beginPath()}};w.prototype.renderSpline=function(a){function b(a){a=fa(a,2);if(0<a.length){c.beginPath();u&&d.beginPath();c.moveTo(a[0].x,a[0].y);u&&d.moveTo(a[0].x,a[0].y);for(var b=0;b<a.length-3;b+=3)c.bezierCurveTo(a[b+1].x,a[b+1].y,a[b+2].x,a[b+2].y,a[b+3].x,a[b+3].y),u&&d.bezierCurveTo(a[b+
1].x,a[b+1].y,a[b+2].x,a[b+2].y,a[b+3].x,a[b+3].y),0<b&&0===b%3E3&&(c.stroke(),c.beginPath(),c.moveTo(a[b+3].x,a[b+3].y),u&&(d.stroke(),d.beginPath(),d.moveTo(a[b+3].x,a[b+3].y)));c.stroke();u&&d.stroke()}}var c=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var d=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var e=[],f=0;f<a.dataSeriesIndexes.length;f++){var g=a.dataSeriesIndexes[f],l=this.data[g];c.lineWidth=l.lineThickness;
var q=l.dataPoints,h=l.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:g};h=A(h);d.strokeStyle=h;d.lineWidth=0<l.lineThickness?Math.max(l.lineThickness,4):0;h=l._colorSet[0];c.strokeStyle=h;var k=0,n,m,r=[];c.beginPath();if(0<q.length)for(k=0;k<q.length;k++)if(n=q[k].getTime?q[k].x.getTime():q[k].x,!(n<a.axisX.dataInfo.viewPortMin||n>a.axisX.dataInfo.viewPortMax))if("number"!==typeof q[k].y)0<k&&(b(r),r=[]);else{n=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*
(n-a.axisX.conversionParameters.minimum)+0.5<<0;m=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(q[k].y-a.axisY.conversionParameters.minimum)+0.5<<0;var p=l.dataPointIds[k];this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:g,dataPointIndex:k,x1:n,y1:m};r[r.length]={x:n,y:m};if(0<q[k].markerSize||0<l.markerSize){var s=l.getMarkerProperties(k,n,m,c);e.push(s);p=A(p);u&&e.push({x:n,y:m,ctx:d,type:s.type,size:s.size,color:p,borderColor:p,borderThickness:s.borderThickness})}(q[k].indexLabel||
l.indexLabel)&&this._indexLabels.push({chartType:"spline",dataPoint:q[k],dataSeries:l,point:{x:n,y:m},color:h})}b(r)}I.drawMarkers(e);c.restore();c.beginPath();u&&d.beginPath()}};var D=function(a,b,c,d,e,f,g,l,q,h,k,n,m){"undefined"===typeof m&&(m=1);g=g||0;l=l||"black";var r=15<d-b&&15<e-c?8:0.35*Math.min(d-b,e-c);a.beginPath();a.moveTo(b,c);a.save();a.fillStyle=f;a.globalAlpha=m;a.fillRect(b,c,d-b,e-c);a.globalAlpha=1;0<g&&(m=0===g%2?0:0.5,a.beginPath(),a.lineWidth=g,a.strokeStyle=l,a.moveTo(b,
...
"rgba(255, 255, 255, 0.1)"),a.fillStyle=g,g.addColorStop(0,f),g.addColorStop(1,"rgba(255, 255, 255, 0.1)"),a.fillStyle=g,a.fill(),a.closePath(),a.restore())};w.prototype.renderColumn=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,d=this.plotArea,e=0,f,g,l,q=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)<<0,e=Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<
0,h=a.axisX.dataInfo.minDiff,k=0.9*(d.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(h)/a.plotType.totalDataSeries)<<0;k>e?k=e:Infinity===h?k=e:1>k&&(k=1);b.save();u&&this._eventManager.ghostCtx.save();b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();u&&(this._eventManager.ghostCtx.rect(d.x1,d.y1,d.width,d.height),this._eventManager.ghostCtx.clip());for(d=0;d<a.dataSeriesIndexes.length;d++){var h=a.dataSeriesIndexes[d],n=this.data[h],m=n.dataPoints;if(0<m.length)for(var r=5<k&&
...
d)*k<<0;var p=f+k<<0,s;0<=m[e].y?s=q:(s=g,g=q);g>s&&(s=g=s);c=m[e].color?m[e].color:n._colorSet[e%n._colorSet.length];D(b,f,g,p,s,c,0,null,r&&0<=m[e].y,0>m[e].y&&r,!1,!1,n.fillOpacity);c=n.dataPointIds[e];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:g,x2:p,y2:s};c=A(c);u&&D(this._eventManager.ghostCtx,f,g,p,s,c,0,null,!1,!1,!1,!1);(m[e].indexLabel||n.indexLabel)&&this._indexLabels.push({chartType:"column",dataPoint:m[e],dataSeries:n,point:{x:f+
(p-f)/2,y:0<=m[e].y?g:s},direction:0<=m[e].y?1:-1,bounds:{x1:f,y1:Math.min(g,s),x2:p,y2:Math.max(g,s)},color:c})}}b.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderStackedColumn=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,d=this.plotArea,e=[],f=[],g=0,l,q=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)<<0,g=0.15*this.width<<0,h=a.axisX.dataInfo.minDiff,k=0.9*(d.width/
...
for(g=0;g<r.length;g++)if(c=r[g].x.getTime?r[g].x.getTime():r[g].x,!(c<a.axisX.dataInfo.viewPortMin||c>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[g].y){d=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(c-a.axisX.conversionParameters.minimum)+0.5<<0;l=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(r[g].y-a.axisY.conversionParameters.minimum)+0.5<<0;var s=d-a.plotType.plotUnits.length*k/2+a.index*k<<0,v=s+k<<0,t;if(0<=r[g].y){var x=
e[c]?e[c]:0;l-=x;t=q-x;e[c]=x+(t-l)}else x=f[c]?f[c]:0,t=l+x,l=q+x,f[c]=x+(t-l);c=r[g].color?r[g].color:m._colorSet[g%m._colorSet.length];D(b,s,l,v,t,c,0,null,p&&0<=r[g].y,0>r[g].y&&p,!1,!1,m.fillOpacity);c=m.dataPointIds[g];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:g,x1:s,y1:l,x2:v,y2:t};c=A(c);u&&D(this._eventManager.ghostCtx,s,l,v,t,c,0,null,!1,!1,!1,!1);(r[g].indexLabel||m.indexLabel)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:r[g],
dataSeries:m,point:{x:d,y:0<=r[g].y?l:t},direction:0<=r[g].y?1:-1,bounds:{x1:s,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:c})}}}b.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderStackedColumn100=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,d=this.plotArea,e=[],f=[],g=0,l,q=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)<<0,g=0.15*this.width<<0,h=a.axisX.dataInfo.minDiff,
...
k<<0,v=s+k<<0,t;if(0<=r[g].y){var x=e[c]?e[c]:0;l-=x;t=q-x;e[c]=x+(t-l)}else x=f[c]?f[c]:0,t=l+x,l=q+x,f[c]=x+(t-l);c=r[g].color?r[g].color:m._colorSet[g%m._colorSet.length];D(b,s,l,v,t,c,0,null,p&&0<=r[g].y,0>r[g].y&&p,!1,!1,m.fillOpacity);c=m.dataPointIds[g];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:g,x1:s,y1:l,x2:v,y2:t};c=A(c);u&&D(this._eventManager.ghostCtx,s,l,v,t,c,0,null,!1,!1,!1,!1);(r[g].indexLabel||m.indexLabel)&&this._indexLabels.push({chartType:"stackedColumn100",
dataPoint:r[g],dataSeries:m,point:{x:d,y:0<=r[g].y?l:t},direction:0<=r[g].y?1:-1,bounds:{x1:s,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:c})}}b.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderBar=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,d=this.plotArea,e=0,f,g,l,q=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)<<0,e=Math.min(0.15*this.height,0.9*(this.plotArea.height/
...
g-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+d)*k<<0;var p=g+k<<0,s;0<=m[e].y?s=q:(s=f,f=q);c=m[e].color?m[e].color:n._colorSet[e%n._colorSet.length];D(b,s,g,f,p,c,0,null,r,!1,!1,!1,n.fillOpacity);c=n.dataPointIds[e];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:s,y1:g,x2:f,y2:p};c=A(c);u&&D(this._eventManager.ghostCtx,s,g,f,p,c,0,null,!1,!1,!1,!1);this._indexLabels.push({chartType:"bar",dataPoint:m[e],dataSeries:n,point:{x:0<=m[e].y?
f:s,y:g+(p-g)/2},direction:0<=m[e].y?1:-1,bounds:{x1:Math.min(s,f),y1:g,x2:Math.max(s,f),y2:p},color:c})}}}b.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderStackedBar=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,d=this.plotArea,e=[],f=[],g=0,l,q=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)<<0,g=0.15*this.width<<0,h=a.axisX.dataInfo.minDiff,k=0.9*(d.height/Math.abs(a.axisX.maximum-
a.axisX.minimum)*Math.abs(h)/a.plotType.plotUnits.length)<<0;k>g?k=g:Infinity===h?k=g:1>k&&(k=1);b.save();u&&this._eventManager.ghostCtx.save();b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();u&&(this._eventManager.ghostCtx.rect(d.x1,d.y1,d.width,d.height),this._eventManager.ghostCtx.clip());for(h=0;h<a.dataSeriesIndexes.length;h++){var n=a.dataSeriesIndexes[h],m=this.data[n],r=m.dataPoints;if(0<r.length){var p=5<k&&m.bevelEnabled?!0:!1;b.strokeStyle="#4572A7 ";for(g=0;g<r.length;g++)if(c=
r[g].x.getTime?r[g].x.getTime():r[g].x,!(c<a.axisX.dataInfo.viewPortMin||c>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[g].y){d=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(c-a.axisX.conversionParameters.minimum)+0.5<<0;l=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(r[g].y-a.axisY.conversionParameters.minimum)+0.5<<0;var s=d-a.plotType.plotUnits.length*k/2+a.index*k<<0,v=s+k<<0,t;if(0<=r[g].y){var x=e[c]?e[c]:0;t=q+x;
l+=x;e[c]=x+(l-t)}else x=f[c]?f[c]:0,t=l-x,l=q-x,f[c]=x+(l-t);c=r[g].color?r[g].color:m._colorSet[g%m._colorSet.length];D(b,t,s,l,v,c,0,null,p,!1,!1,!1,m.fillOpacity);c=m.dataPointIds[g];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:g,x1:t,y1:s,x2:l,y2:v};c=A(c);u&&D(this._eventManager.ghostCtx,t,s,l,v,c,0,null,!1,!1,!1,!1);this._indexLabels.push({chartType:"stackedBar",dataPoint:r[g],dataSeries:m,point:{x:0<=r[g].y?l:t,y:d},direction:0<=r[g].y?1:-1,
bounds:{x1:Math.min(t,l),y1:s,x2:Math.max(t,l),y2:v},color:c})}}}b.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderStackedBar100=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,d=this.plotArea,e=[],f=[],g=0,l,q=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)<<0,g=0.15*this.width<<0,h=a.axisX.dataInfo.minDiff,k=0.9*(d.height/Math.abs(a.axisX.maximum-a.axisX.minimum)*
Math.abs(h)/a.plotType.plotUnits.length)<<0;k>g?k=g:Infinity===h?k=g:1>k&&(k=1);b.save();u&&this._eventManager.ghostCtx.save();b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();u&&(this._eventManager.ghostCtx.rect(d.x1,d.y1,d.width,d.height),this._eventManager.ghostCtx.clip());for(h=0;h<a.dataSeriesIndexes.length;h++){var n=a.dataSeriesIndexes[h],m=this.data[n],r=m.dataPoints;if(0<r.length){var p=5<k&&m.bevelEnabled?!0:!1;b.strokeStyle="#4572A7 ";for(g=0;g<r.length;g++)if(c=r[g].x.getTime?
r[g].x.getTime():r[g].x,!(c<a.axisX.dataInfo.viewPortMin||c>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[g].y){d=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(c-a.axisX.conversionParameters.minimum)+0.5<<0;l=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*((0!==a.dataPointYSums[c]?100*(r[g].y/a.dataPointYSums[c]):0)-a.axisY.conversionParameters.minimum)+0.5<<0;var s=d-a.plotType.plotUnits.length*k/2+a.index*k<<0,v=s+k<<0,t;
if(0<=r[g].y){var x=e[c]?e[c]:0;t=q+x;l+=x;e[c]=x+(l-t)}else x=f[c]?f[c]:0,t=l-x,l=q-x,f[c]=x+(l-t);c=r[g].color?r[g].color:m._colorSet[g%m._colorSet.length];D(b,t,s,l,v,c,0,null,p,!1,!1,!1,m.fillOpacity);c=m.dataPointIds[g];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:g,x1:t,y1:s,x2:l,y2:v};c=A(c);u&&D(this._eventManager.ghostCtx,t,s,l,v,c,0,null,!1,!1,!1,!1);this._indexLabels.push({chartType:"stackedBar100",dataPoint:r[g],dataSeries:m,point:{x:0<=
r[g].y?l:t,y:d},direction:0<=r[g].y?1:-1,bounds:{x1:Math.min(t,l),y1:s,x2:Math.max(t,l),y2:v},color:c})}}}b.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderArea=function(a){function b(){x&&(0<h.lineThickness&&c.stroke(),0>=a.axisY.minimum&&0<=a.axisY.maximum?t=v:0>a.axisY.maximum?t=f.y1:0<a.axisY.minimum&&(t=e.y2),c.lineTo(r,t),c.lineTo(x.x,t),c.closePath(),c.globalAlpha=h.fillOpacity,c.fill(),c.globalAlpha=1,u&&(d.lineTo(r,t),d.lineTo(x.x,t),d.closePath(),d.fill()),c.beginPath(),
c.moveTo(r,p),d.beginPath(),d.moveTo(r,p),x={x:r,y:p})}var c=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var d=this._eventManager.ghostCtx,e=a.axisX.lineCoordinates,f=a.axisY.lineCoordinates,g=[],l=this.plotArea;c.save();u&&d.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();u&&(d.beginPath(),d.rect(l.x1,l.y1,l.width,l.height),d.clip());for(l=0;l<a.dataSeriesIndexes.length;l++){var q=a.dataSeriesIndexes[l],h=this.data[q],k=h.dataPoints,g=h.id;this._eventManager.objectMap[g]=
{objectType:"dataSeries",dataSeriesIndex:q};g=A(g);d.fillStyle=g;var g=[],n=!0,m=0,r,p,s,v=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)+0.5<<0,t,x=null;if(0<k.length){var E=h._colorSet[m%h._colorSet.length];c.fillStyle=E;c.strokeStyle=E;c.lineWidth=h.lineThickness;for(var V=!0;m<k.length;m++)if(s=k[m].x.getTime?k[m].x.getTime():k[m].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax))if("number"!==typeof k[m].y)b(),
V=!0;else{r=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(s-a.axisX.conversionParameters.minimum)+0.5<<0;p=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(k[m].y-a.axisY.conversionParameters.minimum)+0.5<<0;n||V?(c.beginPath(),c.moveTo(r,p),x={x:r,y:p},u&&(d.beginPath(),d.moveTo(r,p)),V=n=!1):(c.lineTo(r,p),u&&d.lineTo(r,p),0==m%250&&b());var B=h.dataPointIds[m];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:q,
dataPointIndex:m,x1:r,y1:p};0!==k[m].markerSize&&(0<k[m].markerSize||0<h.markerSize)&&(s=h.getMarkerProperties(m,r,p,c),g.push(s),B=A(B),u&&g.push({x:r,y:p,ctx:d,type:s.type,size:s.size,color:B,borderColor:B,borderThickness:s.borderThickness}));(k[m].indexLabel||h.indexLabel)&&this._indexLabels.push({chartType:"area",dataPoint:k[m],dataSeries:h,point:{x:r,y:p},direction:0<=k[m].y?1:-1,color:E})}b();I.drawMarkers(g)}}c.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderSplineArea=
function(a){function b(){var b=fa(t,2);if(0<b.length){c.beginPath();c.moveTo(b[0].x,b[0].y);u&&(d.beginPath(),d.moveTo(b[0].x,b[0].y));for(var g=0;g<b.length-3;g+=3)c.bezierCurveTo(b[g+1].x,b[g+1].y,b[g+2].x,b[g+2].y,b[g+3].x,b[g+3].y),u&&d.bezierCurveTo(b[g+1].x,b[g+1].y,b[g+2].x,b[g+2].y,b[g+3].x,b[g+3].y);0<h.lineThickness&&c.stroke();0>=a.axisY.minimum&&0<=a.axisY.maximum?s=p:0>a.axisY.maximum?s=f.y1:0<a.axisY.minimum&&(s=e.y2);v={x:b[0].x,y:b[0].y};c.lineTo(b[b.length-1].x,s);c.lineTo(v.x,s);
c.closePath();c.globalAlpha=h.fillOpacity;c.fill();c.globalAlpha=1;u&&(d.lineTo(b[b.length-1].x,s),d.lineTo(v.x,s),d.closePath(),d.fill())}}var c=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var d=this._eventManager.ghostCtx,e=a.axisX.lineCoordinates,f=a.axisY.lineCoordinates,g=[],l=this.plotArea;c.save();u&&d.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();u&&(d.beginPath(),d.rect(l.x1,l.y1,l.width,l.height),d.clip());for(l=0;l<a.dataSeriesIndexes.length;l++){var q=a.dataSeriesIndexes[l],
h=this.data[q],k=h.dataPoints,g=h.id;this._eventManager.objectMap[g]={objectType:"dataSeries",dataSeriesIndex:q};g=A(g);d.fillStyle=g;var g=[],n=0,m,r,p=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)+0.5<<0,s,v=null,t=[];if(0<k.length){color=h._colorSet[n%h._colorSet.length];c.fillStyle=color;c.strokeStyle=color;for(c.lineWidth=h.lineThickness;n<k.length;n++)if(m=k[n].x.getTime?k[n].x.getTime():k[n].x,!(m<a.axisX.dataInfo.viewPortMin||
m>a.axisX.dataInfo.viewPortMax))if("number"!==typeof k[n].y)0<n&&(b(),t=[]);else{m=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(m-a.axisX.conversionParameters.minimum)+0.5<<0;r=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(k[n].y-a.axisY.conversionParameters.minimum)+0.5<<0;var x=h.dataPointIds[n];this._eventManager.objectMap[x]={id:x,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:n,x1:m,y1:r};t[t.length]={x:m,y:r};
if(0!==k[n].markerSize&&(0<k[n].markerSize||0<h.markerSize)){var E=h.getMarkerProperties(n,m,r,c);g.push(E);x=A(x);u&&g.push({x:m,y:r,ctx:d,type:E.type,size:E.size,color:x,borderColor:x,borderThickness:E.borderThickness})}(k[n].indexLabel||h.indexLabel)&&this._indexLabels.push({chartType:"splineArea",dataPoint:k[n],dataSeries:h,point:{x:m,y:r},direction:0<=k[n].y?1:-1,color:color})}b();I.drawMarkers(g)}}c.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderStepArea=function(a){function b(){x&&
...
l=this.plotArea;c.save();u&&d.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();u&&(d.beginPath(),d.rect(l.x1,l.y1,l.width,l.height),d.clip());for(l=0;l<a.dataSeriesIndexes.length;l++){var q=a.dataSeriesIndexes[l],h=this.data[q],k=h.dataPoints,g=h.id;this._eventManager.objectMap[g]={objectType:"dataSeries",dataSeriesIndex:q};g=A(g);d.fillStyle=g;var g=[],n=!0,m=0,r,p,s,v=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)+
0.5<<0,t,x=null,E=!1;if(0<k.length){var w=h._colorSet[m%h._colorSet.length];c.fillStyle=w;c.strokeStyle=w;for(c.lineWidth=h.lineThickness;m<k.length;m++)if(s=k[m].x.getTime?k[m].x.getTime():k[m].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax)){var B=p;"number"!==typeof k[m].y?(b(),E=!0):(r=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(s-a.axisX.conversionParameters.minimum)+0.5<<0,p=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*
(k[m].y-a.axisY.conversionParameters.minimum)+0.5<<0,n||E?(c.beginPath(),c.moveTo(r,p),x={x:r,y:p},u&&(d.beginPath(),d.moveTo(r,p)),E=n=!1):(c.lineTo(r,B),u&&d.lineTo(r,B),c.lineTo(r,p),u&&d.lineTo(r,p),0==m%250&&b()),B=h.dataPointIds[m],this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:m,x1:r,y1:p},0!==k[m].markerSize&&(0<k[m].markerSize||0<h.markerSize)&&(s=h.getMarkerProperties(m,r,p,c),g.push(s),B=A(B),u&&g.push({x:r,y:p,ctx:d,type:s.type,size:s.size,
...
(0-a.axisY.conversionParameters.minimum)<<0,m=this._eventManager.ghostCtx;u&&m.beginPath();b.save();u&&m.save();b.beginPath();b.rect(e.x1,e.y1,e.width,e.height);b.clip();u&&(m.beginPath(),m.rect(e.x1,e.y1,e.width,e.height),m.clip());xValuePresent=[];for(e=0;e<a.dataSeriesIndexes.length;e++){var r=a.dataSeriesIndexes[e],p=this.data[r],s=p.dataPoints;p.dataPointIndexes=[];for(l=0;l<s.length;l++)r=s[l].x.getTime?s[l].x.getTime():s[l].x,p.dataPointIndexes[r]=l,xValuePresent[r]||(g.push(r),xValuePresent[r]=
!0);g.sort(pa)}for(e=0;e<a.dataSeriesIndexes.length;e++){var r=a.dataSeriesIndexes[e],p=this.data[r],s=p.dataPoints,v=!0,t=[],l=p.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:r};l=A(l);m.fillStyle=l;if(0<g.length){c=p._colorSet[0];b.fillStyle=c;b.strokeStyle=c;b.lineWidth=p.lineThickness;for(l=0;l<g.length;l++){k=g[l];var x=null,x=0<=p.dataPointIndexes[k]?s[p.dataPointIndexes[k]]:{x:k,y:0};if(!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&"number"===
typeof x.y){q=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(k-a.axisX.conversionParameters.minimum)+0.5<<0;h=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(x.y-a.axisY.conversionParameters.minimum)+0.5<<0;var E=f[k]?f[k]:0;h-=E;t.push({x:q,y:n-E});f[k]=n-h;if(v)b.beginPath(),b.moveTo(q,h),u&&(m.beginPath(),m.moveTo(q,h)),v=!1;else if(b.lineTo(q,h),u&&m.lineTo(q,h),0==l%250){for(0<p.lineThickness&&b.stroke();0<t.length;){var w=
t.pop();b.lineTo(w.x,w.y);u&&m.lineTo(w.x,w.y)}b.closePath();b.globalAlpha=p.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();b.moveTo(q,h);u&&(m.closePath(),m.fill(),m.beginPath(),m.moveTo(q,h));t.push({x:q,y:n-E})}if(0<=p.dataPointIndexes[k]){var B=p.dataPointIds[p.dataPointIndexes[k]];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:p.dataPointIndexes[k],x1:q,y1:h}}0<=p.dataPointIndexes[k]&&0!==x.markerSize&&(0<x.markerSize||0<p.markerSize)&&(k=p.getMarkerProperties(l,
q,h,b),d.push(k),markerColor=A(B),u&&d.push({x:q,y:h,ctx:m,type:k.type,size:k.size,color:markerColor,borderColor:markerColor,borderThickness:k.borderThickness}));(x.indexLabel||p.indexLabel)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:x,dataSeries:p,point:{x:q,y:h},direction:0<=s[l].y?1:-1,color:c})}}for(0<p.lineThickness&&b.stroke();0<t.length;)w=t.pop(),b.lineTo(w.x,w.y),u&&m.lineTo(w.x,w.y);b.closePath();b.globalAlpha=p.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();b.moveTo(q,
h);u&&(m.closePath(),m.fill(),m.beginPath(),m.moveTo(q,h))}delete p.dataPointIndexes}I.drawMarkers(d);b.restore();u&&m.restore()}};w.prototype.renderStackedArea100=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,d=this.plotArea,e=[],f=[],g=[],l=0,q,h,k,n=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(0-a.axisY.conversionParameters.minimum)<<0,m=0.15*this.width<<0,r=a.axisX.dataInfo.minDiff,r=0.9*d.width/Math.abs(a.axisX.maximum-
a.axisX.minimum)*Math.abs(r)<<0,p=this._eventManager.ghostCtx;b.save();u&&p.save();b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();u&&(p.beginPath(),p.rect(d.x1,d.y1,d.width,d.height),p.clip());xValuePresent=[];for(d=0;d<a.dataSeriesIndexes.length;d++){var s=a.dataSeriesIndexes[d],v=this.data[s],t=v.dataPoints;v.dataPointIndexes=[];for(l=0;l<t.length;l++)s=t[l].x.getTime?t[l].x.getTime():t[l].x,v.dataPointIndexes[s]=l,xValuePresent[s]||(g.push(s),xValuePresent[s]=!0);g.sort(pa)}for(d=0;d<
a.dataSeriesIndexes.length;d++){var s=a.dataSeriesIndexes[d],v=this.data[s],t=v.dataPoints,x=!0,c=v.id;this._eventManager.objectMap[c]={objectType:"dataSeries",dataSeriesIndex:s};c=A(c);p.fillStyle=c;1==t.length&&(r=m);1>r?r=1:r>m&&(r=m);var E=[];if(0<g.length){c=v._colorSet[l%v._colorSet.length];b.fillStyle=c;b.strokeStyle=c;b.lineWidth=v.lineThickness;for(l=0;l<g.length;l++){k=g[l];var w=null,w=0<=v.dataPointIndexes[k]?t[v.dataPointIndexes[k]]:{x:k,y:0};if(!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&
"number"===typeof w.y){h=0!==a.dataPointYSums[k]?100*(w.y/a.dataPointYSums[k]):0;q=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(k-a.axisX.conversionParameters.minimum)+0.5<<0;h=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(h-a.axisY.conversionParameters.minimum)+0.5<<0;var B=f[k]?f[k]:0;h-=B;E.push({x:q,y:n-B});f[k]=n-h;if(x)b.beginPath(),b.moveTo(q,h),u&&(p.beginPath(),p.moveTo(q,h)),x=!1;else if(b.lineTo(q,h),u&&p.lineTo(q,
h),0==l%250){for(0<v.lineThickness&&b.stroke();0<E.length;){var G=E.pop();b.lineTo(G.x,G.y);u&&p.lineTo(G.x,G.y)}b.closePath();b.globalAlpha=v.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();b.moveTo(q,h);u&&(p.closePath(),p.fill(),p.beginPath(),p.moveTo(q,h));E.push({x:q,y:n-B})}if(0<=v.dataPointIndexes[k]){var y=v.dataPointIds[v.dataPointIndexes[k]];this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:v.dataPointIndexes[k],x1:q,y1:h}}0<=v.dataPointIndexes[k]&&
0!==w.markerSize&&(0<w.markerSize||0<v.markerSize)&&(k=v.getMarkerProperties(l,q,h,b),e.push(k),markerColor=A(y),u&&e.push({x:q,y:h,ctx:p,type:k.type,size:k.size,color:markerColor,borderColor:markerColor,borderThickness:k.borderThickness}));(w.indexLabel||v.indexLabel)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:w,dataSeries:v,point:{x:q,y:h},direction:0<=t[l].y?1:-1,color:c})}}for(0<v.lineThickness&&b.stroke();0<E.length;)G=E.pop(),b.lineTo(G.x,G.y),u&&p.lineTo(G.x,G.y);b.closePath();
b.globalAlpha=v.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();b.moveTo(q,h);u&&(p.closePath(),p.fill(),p.beginPath(),p.moveTo(q,h))}delete v.dataPointIndexes}I.drawMarkers(e);b.restore();u&&p.restore()}};w.prototype.renderBubble=function(a){var b=this.plotArea.ctx,c=a.dataSeriesIndexes.length;if(!(0>=c)){var d=this.plotArea,e=0,f,g,l=0.15*this.width<<0,e=a.axisX.dataInfo.minDiff,c=0.9*(d.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(e)/c)<<0;b.save();u&&this._eventManager.ghostCtx.save();
b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();u&&(this._eventManager.ghostCtx.rect(d.x1,d.y1,d.width,d.height),this._eventManager.ghostCtx.clip());for(var q=-Infinity,h=Infinity,k=0;k<a.dataSeriesIndexes.length;k++)for(var n=a.dataSeriesIndexes[k],m=this.data[n],r=m.dataPoints,p=0,e=0;e<r.length;e++)f=r[e].getTime?f=r[e].x.getTime():f=r[e].x,f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax||"undefined"===typeof r[e].z||(p=r[e].z,p>q&&(q=p),p<h&&(h=p));for(var s=25*Math.PI,
...
0.5<<0;g=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(r[e].y-a.axisY.conversionParameters.minimum)+0.5<<0;var p=r[e].z,v=2*Math.max(Math.sqrt((q===h?d/2:s+(d-s)/(q-h)*(p-h))/Math.PI)<<0,1),p=m.getMarkerProperties(e,b);p.size=v;b.globalAlpha=m.fillOpacity;I.drawMarker(f,g,b,p.type,p.size,p.color,p.borderColor,p.borderThickness);b.globalAlpha=1;var t=m.dataPointIds[e];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,
x1:f,y1:g,size:v};v=A(t);u&&I.drawMarker(f,g,this._eventManager.ghostCtx,p.type,p.size,v,v,p.borderThickness);(r[e].indexLabel||m.indexLabel)&&this._indexLabels.push({chartType:"bubble",dataPoint:r[e],dataSeries:m,point:{x:f,y:g},direction:1,color:null})}b.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderScatter=function(a){var b=this.plotArea.ctx,c=a.dataSeriesIndexes.length;if(!(0>=c)){var d=this.plotArea,e=0,f,g,l=0.15*this.width<<0,e=a.axisX.dataInfo.minDiff,c=0.9*(d.width/
...
0,r=0,e=0;e<n.length;e++)if(f=n[e].getTime?f=n[e].x.getTime():f=n[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof n[e].y){f=a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(f-a.axisX.conversionParameters.minimum)+0.5<<0;g=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(n[e].y-a.axisY.conversionParameters.minimum)+0.5<<0;var p=k.getMarkerProperties(e,f,g,b);b.globalAlpha=k.fillOpacity;I.drawMarker(p.x,
p.y,p.ctx,p.type,p.size,p.color,p.color,p.thickness);b.globalAlpha=1;Math.sqrt((m-f)*(m-f)+(r-g)*(r-g))<Math.min(p.size,5)&&n.length>Math.min(this.plotArea.width,this.plotArea.height)||(m=k.dataPointIds[e],this._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:g},m=A(m),u&&I.drawMarker(p.x,p.y,this._eventManager.ghostCtx,p.type,p.size,m,m,p.borderThickness),(n[e].indexLabel||k.indexLabel)&&this._indexLabels.push({chartType:"scatter",dataPoint:n[e],
dataSeries:k,point:{x:f,y:g},direction:1,color:null}),m=f,r=g)}}}b.restore();u&&this._eventManager.ghostCtx.restore()}};w.prototype.renderCandlestick=function(a){var b=this.plotArea.ctx,c=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var d=null,d=this.plotArea,e=0,f,g,l,q,h,k,e=0.015*this.width;f=a.axisX.dataInfo.minDiff;var n=0.7*d.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(f)<<0;n>e?n=e:Infinity===f?n=e:1>n&&(n=1);b.save();u&&c.save();b.beginPath();b.rect(d.x1,d.y1,
d.width,d.height);b.clip();u&&(c.rect(d.x1,d.y1,d.width,d.height),c.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var r=a.dataSeriesIndexes[m],p=this.data[r],s=p.dataPoints;if(0<s.length)for(var v=5<n&&p.bevelEnabled?!0:!1,e=0;e<s.length;e++)if(s[e].getTime?k=s[e].x.getTime():k=s[e].x,!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&null!==s[e].y&&s[e].y.length&&"number"===typeof s[e].y[0]&&"number"===typeof s[e].y[1]&&"number"===typeof s[e].y[2]&&"number"===typeof s[e].y[3]){f=
a.axisX.conversionParameters.reference+a.axisX.conversionParameters.pixelPerUnit*(k-a.axisX.conversionParameters.minimum)+0.5<<0;g=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(s[e].y[0]-a.axisY.conversionParameters.minimum)+0.5<<0;l=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(s[e].y[1]-a.axisY.conversionParameters.minimum)+0.5<<0;q=a.axisY.conversionParameters.reference+a.axisY.conversionParameters.pixelPerUnit*(s[e].y[2]-
...
b.lineWidth=E;c.lineWidth=Math.max(E,4);"candlestick"===p.type?(b.moveTo(f-w,l),b.lineTo(f-w,Math.min(g,h)),b.stroke(),b.moveTo(f-w,Math.max(g,h)),b.lineTo(f-w,q),b.stroke(),D(b,t,Math.min(g,h),x,Math.max(g,h),s[e].y[0]<=s[e].y[3]?p.risingColor:d,E,d,v,v,!1,!1,p.fillOpacity),u&&(d=A(B),c.strokeStyle=d,c.moveTo(f-w,l),c.lineTo(f-w,Math.min(g,h)),c.stroke(),c.moveTo(f-w,Math.max(g,h)),c.lineTo(f-w,q),c.stroke(),D(c,t,Math.min(g,h),x,Math.max(g,h),d,0,null,!1,!1,!1,!1))):"ohlc"===p.type&&(b.moveTo(f-
w,l),b.lineTo(f-w,q),b.stroke(),b.beginPath(),b.moveTo(f,g),b.lineTo(t,g),b.stroke(),b.beginPath(),b.moveTo(f,h),b.lineTo(x,h),b.stroke(),u&&(d=A(B),c.strokeStyle=d,c.moveTo(f-w,l),c.lineTo(f-w,q),c.stroke(),c.beginPath(),c.moveTo(f,g),c.lineTo(t,g),c.stroke(),c.beginPath(),c.moveTo(f,h),c.lineTo(x,h),c.stroke()));(s[e].indexLabel||p.indexLabel)&&this._indexLabels.push({chartType:p.type,dataPoint:s[e],dataSeries:p,point:{x:t+(x-t)/2,y:l},direction:1,bounds:{x1:t,y1:Math.min(l,q),x2:x,y2:Math.max(l,
q)},color:d})}}b.restore();u&&c.restore()}};w.prototype.renderRangeColumn=function(a){var b=this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,d=this.plotArea,e=0,f,g,e=0.03*this.width;f=a.axisX.dataInfo.minDiff;var l=0.9*(d.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(f)/a.plotType.totalDataSeries)<<0;l>e?l=e:Infinity===f?l=e:1>l&&(l=1);b.save();u&&this._eventManager.ghostCtx.save();b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();u&&(this._eventManager.ghostCtx.rect(d.x1,
...
f.indexLabelFontSize?f.indexLabelFontSize:n.indexLabelFontSize;h.indexLabelFontFamily=f.indexLabelFontFamily?f.indexLabelFontFamily:n.indexLabelFontFamily;h.indexLabelBackgroundColor=f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:n.indexLabelBackgroundColor?n.indexLabelBackgroundColor:null;h.indexLabelMaxWidth=f.indexLabelMaxWidth?f.indexLabelMaxWidth:n.indexLabelMaxWidth?n.indexLabelMaxWidth:0.33*p.width;h.indexLabelWrap=f.indexLabelWrap?f.indexLabelWrap:n.indexLabelWrap;h.startAngle=0===
...
dataSeries:this,distance:Math.min(Math.abs(m.x1-a),Math.abs(m.x2-a),Math.abs(m.y1-b),Math.abs(m.y2-b))}),l=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=R("markerSize",r,this)||4,u=c?20:s,p=Math.sqrt(Math.pow(m.x1-a,2)+Math.pow(m.y1-b,2));p<=u&&d.push({dataPoint:r,dataPointIndex:f,dataSeries:this,distance:p});f=Math.abs(m.x1-a);f<=q?q=f:0<g?h++:k++;p<=s/2&&(l=!0);break;case "rangeArea":case "rangeSplineArea":s=
R("markerSize",r,this)||4;u=c?20:s;p=Math.min(Math.sqrt(Math.pow(m.x1-a,2)+Math.pow(m.y1-b,2)),Math.sqrt(Math.pow(m.x1-a,2)+Math.pow(m.y2-b,2)));p<=u&&d.push({dataPoint:r,dataPointIndex:f,dataSeries:this,distance:p});f=Math.abs(m.x1-a);f<=q?q=f:0<g?h++:k++;p<=s/2&&(l=!0);break;case "bubble":s=m.size;p=Math.sqrt(Math.pow(m.x1-a,2)+Math.pow(m.y1-b,2));p<=s/2&&(d.push({dataPoint:r,dataPointIndex:f,dataSeries:this,distance:p}),l=!0);break;case "pie":case "doughnut":s=m.center;u="doughnut"===this.type?
...
a.setSeconds(0),a.setMilliseconds(0));return a};N(la,K);N(M,K);M.prototype._initialize=function(){if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height="auto";this.container.style.boxShadow="1px 1px 2px 2px rgba(0,0,0,0.1)";this.container.style.zIndex="1000";this.container.style.display="none";var a;a='<div style=" width: auto;height: auto;min-width: 50px;';a+=
...
"doughnut"===c.type)&&(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))){var g="#percent",l="#total";if(0<=c.type.indexOf("stacked"))l=0,0<c.plotUnit.yTotals.length&&(l=c.plotUnit.yTotals[b.x],g=isNaN(b.y)?0:100*(b.y/l));else if("pie"===c.type||"doughnut"===c.type){for(i=l=0;i<c.dataPoints.length;i++)isNaN(c.dataPoints[i].y)||(l+=c.dataPoints[i].y);g=isNaN(b.y)?0:100*(b.y/l)}do{var q="";if(c.percentFormatString)q=c.percentFormatString;else for(var q="#,##0.",h=Math.max(Math.ceil(Math.log(1/g)/Math.LN10),
...
0;b<a.length;b++){var c=a[b];I.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}},ya={Chart:function(a,b){var c=new w(a,b,this);this.render=function(){c.render(this.options)};this.options=c._options},addColorSet:function(a,b){T[a]=b},addCultureInfo:function(a,b){ma[a]=b}};ya.Chart.version="v1.5.5 GA";window.CanvasJS=ya})();
/*
